...
const projects = [
    ...
    },
    {
        ...
        demo: null,
        details: {
            overview: "Asset Tracker Automation is a Python-based workflow tool built for Wanco Inc. that handles the complete fulfillment cycle for Suntech GPS asset trackers. Each order contains 30 trackers that must be individually activated, data-entered into the Plex ERP manufacturing system, and labeled before shipping to production lines.",
            highlights: [
