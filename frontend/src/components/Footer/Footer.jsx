                ...
                <div className="footer-grid">
                    ...
                    <div>
                        ...
                        <div className="footer-links">
                            ...
                            <a href="https://github.com/BrianDang03" target="_blank" rel="noreferrer" aria-label="Brian Dang on GitHub (opens in new tab)">
                                <svg viewBox="0 0 24 24" fill="currentColor" className="ft-link-icon" aria-hidden="true">
